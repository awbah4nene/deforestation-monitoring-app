    ...
    try {
      const response = await fetch("/api/regions", {
        ...
        body: JSON.stringify({
          ...
          geometry: {
            type: "Polygon",
            coordinates: [[]], // Empty polygon - can be edited later
          },
          centroid: {
            type: "Point",
            coordinates: [0, 0], // Default - should be calculated from geometry
          },
        }),
      });
      ...
      >
        <div className="h-full flex flex-col">
          <Card className="h-full flex flex-col rounded-none border-0 shadow-none">
            ...
            <CardContent className="flex-1 overflow-y-auto p-6 region-modal-content">
